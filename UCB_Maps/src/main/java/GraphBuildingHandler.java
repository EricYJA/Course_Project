...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private List<Long> connectionList = new ArrayList<Long>();
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            if (k.equals("highway")
                    && ALLOWED_HIGHWAY_TYPES.contains(v)) {
            ...
            g.setLocation(lastNode.getId(), attributes.getValue("v"));
        ...
        if (qName.equals("way")) {
            ...
            if (flag) {
                for (int i = 0; i < connectionList.size() - 1; i++) {
                    g.addEdge(connectionList.get(i), connectionList.get(i + 1));
                }
            }
